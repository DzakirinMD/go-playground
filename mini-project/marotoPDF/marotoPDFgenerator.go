...
func main() {
	...
	m.Row(40, func() {
		m.Col(4, func() {
			_ = m.FileImage("mini-project/marotoPDF/biplane.png", props.Rect{
				Center:  true,
				Percent: 80,
			})
		})
		m.Col(4, func() {
			m.Text("GO International Shipping, Inc.", props.Text{
				Top:         12,
				Size:        20,
				Extrapolate: true,
			})
	...
	err := m.OutputFileAndClose("mini-project/marotoPDF/test.pdf")
	if err != nil {
	...
	fmt.Println("Finished creating PDF in : ", end.Sub(begin))
}
